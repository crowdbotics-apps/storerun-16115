"""storerun_16115 URL Configuration
...
admin.site.site_header = "StoreRun"
admin.site.site_title = "StoreRun Admin Portal"
admin.site.index_title = "StoreRun Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="StoreRun API",
        default_version="v1",
        description="API documentation for StoreRun App",
    ),
    public=True,
